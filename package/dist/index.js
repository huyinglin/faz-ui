...
function getTypeCSS(base, hover, active) {
  return styled.css(_templateObject(), base.color, base.background, base.borderColor, base.otherCSS, hover.color, hover.background, hover.borderColor, hover.otherCSS, active.color, active.background, active.borderColor, active.otherCSS);
}
...
var Size = {
  default: styled.css(_templateObject2(), function (_ref) {
    var shape = _ref.shape;
    return shape && shape === 'round' ? '4px 16px' : shape === 'circle' ? 'padding: 0;' : '4px 12px';
  }),
  large: styled.css(_templateObject3(), function (_ref2) {
  ...
  small: styled.css(_templateObject4(), function (_ref3) {
...
var Shap = {
  circle: styled.css(_templateObject5()),
  round: styled.css(_templateObject6())
};
var baseDisabled = styled.css(_templateObject7());
var ancharDisabled = styled.css(_templateObject8(), baseDisabled);
var buttonBase = styled.css(_templateObject9());
var ghostCSS = styled.css(_templateObject10(), function (_ref4) {
...
var dangerCSS = styled.css(_templateObject11(), function (_ref6) {
...
var loadingCSS = styled.css(_templateObject12());
var ButtonView = styled__default.button(_templateObject13(), buttonBase, function (_ref15) {
...
var AncharView = styled__default.a(_templateObject14(), buttonBase, Type.link, function (_ref22) {
...
var ButtonIconView = styled__default.span(_templateObject15(), function (_ref26) {
